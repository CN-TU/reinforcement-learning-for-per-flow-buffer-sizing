...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-D_GLIBCXX_USE_CXX11_ABI=0', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++14', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.7-3.7.3=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.7-3.7.3=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-D_GLIBCXX_USE_CXX11_ABI=0', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++14', '-fstrict-aliasing', '-Wstrict-aliasing']
CXXFLAGS_MACBUNDLE = ['-fPIC']
CXXFLAGS_PTHREAD = '-pthread'
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.7-3.7.3=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.7-3.7.3=.', '-fstack-protector', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES = ['NS3_BUILD_PROFILE_OPTIMIZED', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1', 'HAVE_GCRYPT=1']
...
INCLUDES = ['/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/libtorch/include', '/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/libtorch/include/torch/csrc/api/include']
INCLUDES_BOOST = '/usr/include'
INCLUDES_LIBXML2 = ['/usr/include/libxml2']
INCLUDES_PYEMBED = ['/usr/include/python3.7m']
INCLUDES_PYEXT = ['/usr/include/python3.7m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBGCRYPT_CONFIG = ['/usr/bin/libgcrypt-config']
LIBPATH_PYEMBED = ['/usr/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/usr/lib']
LIBPATH_PYEXT = ['/usr/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/usr/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_GCRYPT = ['gcrypt']
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.7m', 'crypt', 'pthread', 'dl', 'util', 'm', 'python3.7m', 'crypt', 'pthread', 'dl', 'util', 'm']
LIB_PYEXT = ['python3.7m', 'crypt', 'pthread', 'dl', 'util', 'm', 'python3.7m', 'crypt', 'pthread', 'dl', 'util', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
LINKFLAGS = ['-L/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/libtorch/lib', '-ltorch', '-ltorch_cpu', '-lc10']
...
NS3_EXECUTABLE_PATH = ['/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/ns-allinone-3.30.1/ns-3.30.1/build/src/fd-net-device', '/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/ns-allinone-3.30.1/ns-3.30.1/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/8', '/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/ns-allinone-3.30.1/ns-3.30.1/build/lib']
...
VERSION = '3.30.1'
WITH_PYBINDGEN = '/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/ns-allinone-3.30.1/pybindgen-0.20.0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/ns-allinone-3.30.1/ns-3.30.1/build/ns3/config-store-config.h', '/home/max/repos/reinforcement-learning-for-per-flow-buffer-sizing/ns-allinone-3.30.1/ns-3.30.1/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
pyext_PATTERN = '%s.cpython-37m-x86_64-linux-gnu.so'
