...
void
CreateBulkFlow (AddressValue remoteAddress, Ptr<ns3::Node> sender, uint32_t pktSize, float stopTime)
{
...
void
CreateOnOffFlow (AddressValue remoteAddress, Ptr<ns3::Node> sender, float stopTime)
{
